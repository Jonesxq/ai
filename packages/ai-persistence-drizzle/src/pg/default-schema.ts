 ...
 *
 * Prefer owning this shape in your project via `tanstack-ai-drizzle-schema --dialect pg` and
 * generating DDL with **your** drizzle-kit journal. This factory is the runtime
 * convenience default for apps that want
 ...
 * or prefer the file emitted by `tanstack-ai-drizzle-schema --dialect pg` when you want
